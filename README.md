...
| 機能 | 内容 |
| ------- | ------- |
| インスタンスの生成 | レストランの注文に関わる情報はすべてクラスで管理しています。<br>システムが実行されると、クラスからインスタンスを生成することで、レストランの注文が始まるようになっています。<br>このシステムの構造を理解してもらうために[クラス図](#クラス図)を作成していますので、そちらを確認ください。 |
